...
<template>
	<div class="settings">
		...
		<div class="settings-body">
			<div class="msg">已创建<span v-html="pageNum"></span>个未知问答</div>
...
import ipAddress from './config.js'
	export default {
			created: function () {
		    this.$http({
	            url: `${ipAddress.ip}/DeltaRobot/qa/unkquery.action?userQuestion=${this.questionContent}&currentPage=${this.currentPage}&perPageCount=8`,
	            method: 'POST',
	            // 请求体发送的数据
	            data: {
